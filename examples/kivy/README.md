...
Instead the recipe build must be cleaned:
    ...
    buildozer android p4a -- clean_recipe_build --local-recipes $(pwd)/../../bleak/backends/android/p4android/recipes bleak

## To use bleak in your own app:

- Copy the bleak folder under bleak/backends/android/p4android/recipes into the app recipes folder.
